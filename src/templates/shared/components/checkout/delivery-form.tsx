...
const deliveryOptions: DeliveryOption[] = [
    {
        ...
        price: 15.00,
        icon: <Truck className="h-4 w-4 text-tpl-fg-muted" />
    },
    {
        id: "express",
        ...
        price: 25.00,
        icon: <Clock className="h-4 w-4 text-tpl-accent" />,
        badge: "Fast",
        badgeColor: "bg-tpl-accent-soft text-tpl-accent"
    }
]
        ...
        <div className="rounded-2xl border border-tpl-line bg-white p-6 shadow-sm">
            <div className="mb-6 flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-tpl-accent-soft">
                    <span className="text-sm font-bold text-tpl-accent">3</span>
                </div>
                <h2 className="text-xl font-bold text-tpl-fg">Delivery Options</h2>
            </div>
                                    ...
                                    {deliveryOptions.map((option) => (
                                        <div
                                            ...
                                            className={`flex items-start space-x-3 rounded-lg border p-4 transition-colors ${selectedOption === option.id
                                                ? "border-tpl-accent bg-tpl-accent-soft/50"
                                            ...
                                            <div className="flex-1">
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-tpl-fg-muted">{option.description}</p>
                                                        <p className="text-sm text-tpl-fg-muted">{option.duration}</p>
                                                    </div>
                                                    <span className="font-bold text-tpl-fg">
